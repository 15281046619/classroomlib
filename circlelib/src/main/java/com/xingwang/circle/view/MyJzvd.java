 ...
 */
public abstract class MyJzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    public static final String TAG = "JZVD";
    public static MyJzvd CURRENT_JZVD;
    ...
    public MyJZMediaInterface mediaInterface;
    ...
    public void setUp(JZDataSource jzDataSource, int screen) {
        setUp(jzDataSource, screen, MyJZMediaSystem.class);
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start) {
            ...
            if (screenState == SCREEN_FULLSCREEN) {
                //quit fullscreen
                backPress();
                screenState=SCREEN_NORMAL;
            } else {
...
//                        mDownY = y;
    ...
    public void reset() {
        ...
        MyJZMediaInterface.SAVED_SURFACE = null;
    ...
    public void startVideo() {
        ...
        setCurrentJzvd(this);
        Constructor<MyJZMediaInterface> constructor = null;
        try {
            constructor = mediaInterfaceClass.getConstructor(MyJzvd.class);
...
//        Log.d(TAG, "onProgress: progress=" + progress + " position=" + position + " duration=" + duration);
    ...
    public void cloneAJzvd(ViewGroup vg) {
        try {
            Constructor<MyJzvd> constructor = (Constructor<MyJzvd>) MyJzvd.this.getClass().getConstructor(Context.class);
            MyJzvd jzvd = constructor.newInstance(getContext());
            jzvd.setId(getId());
            vg.addView(jzvd);
...
//                && CURRENT_JZVD != null
    ...
    public static class JZAutoFullscreenListener implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {//可以得到传感器实时测量出来的变化值
            ...
            if (x < -12 || x > 12) {
                if ((System.currentTimeMillis() - lastAutoFullscreenTime) > 2000) {
                    if (MyJzvd.CURRENT_JZVD != null) MyJzvd.CURRENT_JZVD.autoFullscreen(x);
                    lastAutoFullscreenTime = System.currentTimeMillis();
                }
            }
        }
...
//                Log.v(TAG, "onProgressUpdate " + "[" + this.hashCode() + "] ");
        ...
        public void onAudioFocusChange(int focusChange) {
            switch (focusChange) {
                ...
                case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT:
                    try {
                        MyJzvd player = CURRENT_JZVD;
                        if (player != null && player.state == MyJzvd.STATE_PLAYING) {
    ...
    public static void goOnPlayOnResume() {
        if (CURRENT_JZVD != null) {
            if (CURRENT_JZVD.state == MyJzvd.STATE_PAUSE) {
    ...
    public static void goOnPlayOnPause() {
        if (CURRENT_JZVD != null) {
            if (CURRENT_JZVD.state == MyJzvd.STATE_AUTO_COMPLETE ||
                    CURRENT_JZVD.state == MyJzvd.STATE_NORMAL ||
                    CURRENT_JZVD.state == MyJzvd.STATE_ERROR) {
    ...
    public static void startFullscreenDirectly(Context context, Class _class, JZDataSource jzDataSource) {
        ...
        try {
            Constructor<MyJzvd> constructor = _class.getConstructor(Context.class);
            final MyJzvd jzvd = constructor.newInstance(context);
            FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
            vp.addView(jzvd, lp);
            jzvd.setUp(jzDataSource, MyJzvdStd.SCREEN_FULLSCREEN);
            jzvd.startVideo();
        } catch (InstantiationException e) {
            e.printStackTrace();
        } catch (Exception e) {
    ...
    public static void setCurrentJzvd(MyJzvd jzvd) {
    ...
    public static void setVideoImageDisplayType(int type) {
        MyJzvd.VIDEO_IMAGE_DISPLAY_TYPE = type;
        if (CURRENT_JZVD != null && CURRENT_JZVD.textureView != null) {
