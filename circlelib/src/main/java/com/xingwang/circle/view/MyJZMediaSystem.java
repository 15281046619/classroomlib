...
public class MyJZMediaSystem  extends MyJZMediaInterface implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
    ...
    public MyJZMediaSystem(MyJzvd jzvd) {
        super(jzvd);
    }
