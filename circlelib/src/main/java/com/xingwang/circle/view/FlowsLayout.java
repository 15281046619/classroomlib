...
//            Collections.reverse(lineViews);
    ...
    public void addUrls(String urlVal) {
        allUrls.add(urlVal);
        setViews();
    }

    public void addUrls(List<String> listVals) {
        allUrls.addAll(listVals);
        setViews();
    }
    ...
    private void setViews() {
        ...
        for (int i = 0; i < allUrls.size(); i++) {
            ...
            NiceImageView imageView = (NiceImageView) LayoutInflater.from(context).inflate(R.layout.circle_item_praise, this, false);

            GlideUtils.loadPic(allUrls.get(i),imageView,context.getApplicationContext());
