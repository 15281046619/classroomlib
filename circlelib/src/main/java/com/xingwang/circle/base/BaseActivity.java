   ...
   /* public OSS initOSS(){
        ...
        OSSCredentialProvider provider=new OSSCustomSignerCredentialProvider(){
            ...
            public String signContent(String content) {
                String signedString = OSSUtils.sign(Constants.OSS_ACCESS_KEY_ID, Constants.OSS_ACCESS_KEY_SECRET, content);
                return signedString;
            }
        };

        OSS oss=new OSSClient(getApplicationContext(),Constants.OSS_ENDPOINT,provider);
        return oss;
    }*/
