...
public class DanmuVideoActivity extends BaseActivity {
    ...
    protected NestedScrollView postDetailNestedScroll;;
    protected DanmakuVideoPlayer danmakuVideoPlayer;
    protected RelativeLayout activityDetailPlayer;
    ...
    protected InDanmuDialog danmuDialog;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // String url = "http://ivi.bupt.edu.cn/hls/cctv1hd.m3u8";
        ...
        imageView.setImageResource(R.mipmap.ic_pl_classroom);
        ...
        danmakuVideoPlayer.setNeedLockFull(false);
        ...
        danmakuVideoPlayer.getFullscreenButton().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                danmakuVideoPlayer.startWindowFullscreen(DanmuVideoActivity.this, true, true);
            }
        });
    ...
    private void getDanmu() {
       // ((DanmakuVideoPlayer) danmakuVideoPlayer.getCurrentPlayer()).set(response);
        //下载demo然后设置
